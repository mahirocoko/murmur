...
3. ตั้งค่า Language / Output ใน General ถ้าต้องการเปลี่ยนค่า default
...
- **Global shortcut** — ใช้ `Option + Space` สำหรับเริ่ม/หยุด dictation

Murmur ไม่ register global `Esc` แล้ว เพื่อไม่ให้กินปุ่ม Esc จากแอปอื่น ตอนนี้ `Esc` จะ cancel ได้เฉพาะตอน main window focus อยู่เท่านั้น
